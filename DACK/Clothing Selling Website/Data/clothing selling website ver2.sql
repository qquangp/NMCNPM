...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2021 at 03:46 PM
...
CREATE TABLE `tbl_product` (
  ...
  `ProductCode` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `ProductQuantity` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `ProductSoldOut` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `ProductRemain` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `CateID` int(11) NOT NULL,
  `BrandID` int(11) NOT NULL,
