...
<!DOCTYPE HTML>
<head>
<title>Online Selling Clothing Store</title>
		...
		<div class="header_top">
			  ...
			  <div class="header_top_right">
			    <div class="search_box">
				    <form action="search.php" method="post">
				    	<input type="text" placeholder="Searching for ..." name="tukhoa">
		   ...
		   <div class="login">
			...
			if($login_check==false){
				echo '<a href="login.php">Sign In</a></div>';
			}else{
				echo '<a href="?customer_id='.Session::get('customer_id').'">Sign Out</a></div>';
			}
			?>
		 <div class="clear"></div>
	 </div>
